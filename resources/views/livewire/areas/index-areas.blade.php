    ...
    <div class="ui container">
        ...
        <form class="ui form" wire:submit.prevent="handleSearch">
            <div class="fields">
                ...
                <div class="field">
                    <div class="ui fluid teal button" target-modal="create-area-modal"><i class="plus icon"></i>Añadir
                    </div>
                </div>
            </div>
        </form>
        ...
        <div class="ui vertical basic segment">
            <div class="ui three stackable doubling raised link cards">
                ...
                <div class="card" wire:loading.class="ui loading">
                 ...
                 @endforeach" data-variation="tiny multiline" data-position="bottom left" data-inverted>
                            {{ $area->careers->count() }} carreras asociadas</div>
                        <div class="ui justified description container">
                            <p>{{ $area->description }}</p>
                        </div>
                    </div>
                    <div class="ui two bottom attached buttons">
                        <div class="ui teal button" target-modal="edit-area-{{ $area->id }}-modal"><i
                                class="pen icon"></i>Editar</div>
                        <div class="ui red button" target-modal="delete-area-{{ $area->id }}-modal"><i
                                class="trash icon"></i>Eliminar</div>
                    </div>
                </div>
                @empty
            </div>
