    ...
    <div class="ui grid">
        <div class="ui mobile only row container">
            <div class="ui dropdown icon item">
                <i class="bars icon"></i>
                <div class="menu">
                    <a class="item {{ Route::currentRouteName() === 'index' || Route::currentRouteName() === 'home' ? 'active' : '' }}"
                        href="{{ route('home') }}"><i class="university icon"></i>Inicio</a>
    ...
    <div class="right menu">
        ...
        <div class="ui dropdown item">
            ...
            <div class="menu">
                ...
                @if (Auth::user()->role === 'super' || Auth::user()->role === 'admin' || Auth::user()->role ===
                'manager')
                <div class="item {{ Route::currentRouteName() === 'areas' || Route::currentRouteName() === 'careers' ? 'active' : '' }}"
                    ...
                    <div class="menu">
                        <a class="item {{ Route::currentRouteName() === 'areas' ? 'active' : '' }}"
                            href="{{ route('areas') }}"><i class="grip horizontal icon"></i>Áreas</a>
                        <a class="item {{ Route::currentRouteName() === 'careers' ? 'active' : '' }}"
                            href="{{ route('careers') }}"><i class="th icon"></i>Carreras</a>
                        <a class="item {{ Route::currentRouteName() === 'users' ? 'active' : '' }}"
                            href="{{ route('users') }}"><i class="users icon"></i>Usuarios</a>
